...
tf.flags.DEFINE_string("training_file","../processed_data/splited_train_data.csv","Training file that has splited")
...
print("Loading Data...")
x_text,y = Data_helper.load_data_and_labels(FLAGS.training_file)
y = np.array(y)
